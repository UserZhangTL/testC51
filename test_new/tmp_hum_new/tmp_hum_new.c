...
库使用方法： 单片机时钟为11.0592M，适用于低速12分频单片机
只有DHT11.h中的两个函数可以被外界函数调用
可以在延时1S之后直接读数据（中间包含了初始化），两次读取数据时间间隔最好
大于2S 
整理人:张家越			整理时间：2012-04-30
个人空间：hi.baidu.com/zhangjiayue123/home/ 
